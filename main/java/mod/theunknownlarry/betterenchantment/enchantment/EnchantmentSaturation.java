...
public class EnchantmentSaturation extends Enchantment {
	...
	public EnchantmentSaturation() {
		...
		this.setRegistryName(new ResourceLocation(Main.MODID + ":saturation"));
	...
	protected boolean canApplyTogether(Enchantment ench) {
		...
		return super.canApplyTogether(ench) && ench != mod.theunknownlarry.betterenchantment.init.EnchantmentInit.HUNGER;
