...
public class EnchantmentDolphinsGrace extends Enchantment {

	public EnchantmentDolphinsGrace() {
		
		super(Rarity.VERY_RARE, EnumEnchantmentType.ARMOR_FEET, new EntityEquipmentSlot[] {EntityEquipmentSlot.FEET});
		this.setName("Dolphins_Grace");
		this.setRegistryName(new ResourceLocation(Main.MODID + ":dolphins_grace"));
