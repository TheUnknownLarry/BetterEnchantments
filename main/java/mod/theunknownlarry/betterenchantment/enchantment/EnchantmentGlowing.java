...
public class EnchantmentGlowing extends Enchantment {
	...
	public EnchantmentGlowing() {
		...
		this.setRegistryName(new ResourceLocation(Main.MODID + ":glowing"));
	...
	protected boolean canApplyTogether(Enchantment ench) {
		...
		return super.canApplyTogether(ench) && ench != mod.theunknownlarry.betterenchantment.init.EnchantmentInit.INVISIBILITY;
