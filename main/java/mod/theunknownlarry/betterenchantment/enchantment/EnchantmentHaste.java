...
public class EnchantmentHaste extends Enchantment {
	...
	public EnchantmentHaste() {
		...
		this.setName("Haste");
		this.setRegistryName(new ResourceLocation(Main.MODID + ":haste"));
	...
	protected boolean canApplyTogether(Enchantment ench) {
		...
		return super.canApplyTogether(ench) && ench != mod.theunknownlarry.betterenchantment.init.EnchantmentInit.SLOWNESS && ench != mod.theunknownlarry.betterenchantment.init.EnchantmentInit.MINING_FATIGUE;
