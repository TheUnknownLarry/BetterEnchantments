...
public class EnchantmentInvisibility extends Enchantment {
	...
	public EnchantmentInvisibility() {
		...
		this.setRegistryName(new ResourceLocation(Main.MODID + ":invisibility"));
	...
	protected boolean canApplyTogether(Enchantment ench) {
		...
		return super.canApplyTogether(ench) && ench != mod.theunknownlarry.betterenchantment.init.EnchantmentInit.GLOWING;
