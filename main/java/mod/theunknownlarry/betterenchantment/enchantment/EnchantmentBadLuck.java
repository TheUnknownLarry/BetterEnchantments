...
public class EnchantmentBadLuck extends Enchantment {

	public EnchantmentBadLuck() {
		...
		this.setName("Bad Luck");
		this.setRegistryName(new ResourceLocation(Main.MODID + ":bad_luck"));
	...
	protected boolean canApplyTogether(Enchantment ench) {
		...
		return super.canApplyTogether(ench) && ench != mod.theunknownlarry.betterenchantment.init.EnchantmentInit.LUCK;
