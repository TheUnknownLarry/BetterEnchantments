...
public class EnchantmentStrength extends Enchantment {
	...
	public EnchantmentStrength() {
		...
		this.setRegistryName(new ResourceLocation(Main.MODID + ":strength"));
	...
	protected boolean canApplyTogether(Enchantment ench) {
		...
		return super.canApplyTogether(ench) && ench != mod.theunknownlarry.betterenchantment.init.EnchantmentInit.WEAKNESS;
