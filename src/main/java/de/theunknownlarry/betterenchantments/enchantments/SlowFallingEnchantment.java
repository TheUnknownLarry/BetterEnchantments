...
public class SlowFallingEnchantment extends EnchantmentParent {
	public SlowFallingEnchantment() {
		super(2, EnchantmentCategory.ARMOR_FEET, EquipmentSlot.FEET);
	}

	protected boolean checkCompatibility(@NotNull Enchantment p_44690_) {
		return super.checkCompatibility(p_44690_) && p_44690_ != EnchantmentInit.LEVITATION.get();
	}
