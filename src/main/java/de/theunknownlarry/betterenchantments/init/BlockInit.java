...
import de.theunknownlarry.betterenchantments.blocks.EnchantmentDeterminerBlock;
...
public class BlockInit {
	...
	public static final RegistryObject<Block> ENCHANTMENT_DETERMINER = register("enchantment_determiner",
		() -> new EnchantmentDeterminerBlock(BlockBehaviour.Properties.of(Material.STONE).requiresCorrectToolForDrops().strength(5.0F, 1200.0F)),
